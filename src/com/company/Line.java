...
public class Line {
    ...
    {
        double lineDis = Math.sqrt(Math.pow(end2.getX() - end1.getX(), 2) + Math.pow(end2.getY() - end1.getY(), 2));
        return lineDis;
    }

    public Point midpoint()
    {
        double midPointX = (end1.getX() + end2.getX())/2;
        double midPointY = (end1.getY() + end2.getY())/2;
    ...
    {
        double difDis = this.distance() - otherLine.distance();
        return Math.abs(difDis) <= .001;
    }
